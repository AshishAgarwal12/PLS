    ...
    <>
      <footer className="bg-black text-white py-10 w-full">
        ...
        <div className="container p-8 grid grid-cols-12 items-center border-4 border-yellow-700 rounded-lg ">
          ...
          <div className="col-span-12 md:col-span-6 flex justify-center md:justify-start space-x-4">
            {[
              { icon: "twitter", link: "#" },
              { icon: "facebook", link: "#" },
              { icon: "instagram", link: "#" },
              ...
              >
                ...
                <i
                  className={`fa fa-${social.icon} relative z-10 text-white`}
                ></i>
              </a>
            ))}
          </div>
          ...
          {/* Logos */}
          <div className="col-span-12 md:col-span-6 flex justify-center md:justify-end space-x-6">
            {[
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            ...
            <a
              ...
              className="hover:underline hover:text-amber-950"
            >
              dekoshurcrafts.com
            </a>
          </span>
